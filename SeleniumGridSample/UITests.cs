...
namespace SeleniumGridSample
{
    ...
    public  class UITests
    {
        ...
        public UITests()
        {
            var pathGrid = Environment.GetEnvironmentVariable("DotNetSelenium");
            //driver = new ChromeDriver();
            //driver = new ChromeDriver(@"C:\Users\vism\Downloads\chromedriver_win32\");
            ChromeOptions chromeOptions = new ChromeOptions();
            chromeOptions.AddArgument("--start-maximized"); 
            driver = new RemoteWebDriver(new Uri(pathGrid), chromeOptions.ToCapabilities());
        }
       ...
       /* [TestMethod]
        ...
        private void SearchTest(string queryString)
        {
            ...
            query.Submit();
            string text = driver.FindElement(By.TagName("h3")).Text;
            Assert.IsTrue(text.ToUpper().Contains(queryString.ToUpper()));
/*            driver.FindElement(By.TagName("//*[@id='rso']/div/div/div/div/div/h3/a")).Click();
